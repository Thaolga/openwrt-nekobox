    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="form-section">
                <form method="post">
                    ...
                    <div class="mb-3">
                        <label for="filename" class="form-label">Custom file name (default: config.yaml)</label>
                   ...
                   <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary" name="action" value="generate_subscription"><i class="bi bi-terminal"></i> Generate Configuration File</button>
                </form>
            </div>
        </div>
        ...
        <div class="form-section mt-4">
            <form method="post">
                ...
                <button type="submit" class="btn btn-primary" name="action" value="update_cron"><i class="bi bi-clock"></i> Update Cron Job</button>
            </form>
        </div>
