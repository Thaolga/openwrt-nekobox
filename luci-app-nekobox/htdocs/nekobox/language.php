<?php
    ...
    'de' => [
        ...
        'clear_playback_settings' => '🗑️ Wiedergabeeinstellungen löschen',
        ...
        'client_message' => 'Beginne mit dem Download des Client-Updates...',
        'client_description' => 'Client auf die neueste offizielle Version aktualisieren',
        'panel_zashboard_message' => 'Beginne mit dem Download des Zashboard-Panel-Updates...',
        'panel_zashboard_description' => 'Zashboard-Panel auf die neueste Version aktualisieren',
    ...
    'fr' => [
        ...
        'clear_playback_settings' => '🗑️ Effacer les paramètres de lecture',
        ...
        'client_message' => 'Début du téléchargement de la mise à jour du client...',
        'client_description' => 'Mettre à jour le client vers la dernière version officielle',
        'panel_zashboard_message' => 'Début du téléchargement de la mise à jour du panneau Zashboard...',
        'panel_zashboard_description' => 'Mettre à jour le panneau Zashboard vers la dernière version',
    ...
    'hk' => [
        ...
        'weekday' => '星期',
        'weekdays' => ['日', '一', '二', '三', '四', '五', '六'],
        'hourlyAnnouncement' => '現在是 %d 點整，北京時間。',
        'hourlyAlert' => '整點報時',
        'startCheck' => '開始檢查網站連通性...',
        'websiteChecked' => '網站檢查已完成，感謝使用。',
        'checkStarted' => '網站檢查已開始，正在檢查連通性...',
        'statusMessages' => [
            'https://www.baidu.com/' => ['accessible' => '百度網站可以訪問。', 'notAccessible' => '無法訪問百度網站，請檢查網絡連接。'],
            'https://www.cloudflare.com/' => ['accessible' => 'Cloudflare網站可以訪問。', 'notAccessible' => '無法訪問Cloudflare網站，請檢查網絡連接。'],
            'https://openai.com/' => ['accessible' => 'OpenAI網站可以訪問。', 'notAccessible' => '無法訪問OpenAI網站，請檢查網絡連接。'],
            'https://www.youtube.com/' => ['accessible' => 'YouTube網站可以訪問。', 'notAccessible' => '無法訪問YouTube網站，請檢查網絡連接。'],
            'https://www.google.com/' => ['accessible' => 'Google網站可以訪問。', 'notAccessible' => '無法訪問Google網站，請檢查網絡連接。'],
            'https://www.facebook.com/' => ['accessible' => 'Facebook網站可以訪問。', 'notAccessible' => '無法訪問Facebook網站，請檢查網絡連接。'],
            'https://www.twitter.com/' => ['accessible' => 'Twitter網站可以訪問。', 'notAccessible' => '無法訪問Twitter網站，請檢查網絡連接。'],
            'https://www.github.com/' => ['accessible' => 'GitHub網站可以訪問。', 'notAccessible' => '無法訪問GitHub網站，請檢查網絡連接。'],
        ],
    ...
    'jp' => [
        ...
        'statusMessages' => [
            'https://www.baidu.com/' => ['accessible' => 'Baiduウェブサイトにアクセス可能です。', 'notAccessible' => 'Baiduウェブサイトにアクセスできません、ネットワーク接続を確認してください。'],
            'https://www.cloudflare.com/' => ['accessible' => 'Cloudflareウェブサイトにアクセス可能です。', 'notAccessible' => 'Cloudflareウェブサイトにアクセスできません、ネットワーク接続を確認してください。'],
            'https://openai.com/' => ['accessible' => 'OpenAIウェブサイトにアクセス可能です。', 'notAccessible' => 'OpenAIウェブサイトにアクセスできません、ネットワーク接続を確認してください。'],
            'https://www.youtube.com/' => ['accessible' => 'YouTubeウェブサイトにアクセス可能です。', 'notAccessible' => 'YouTubeウェブサイトにアクセスできません、ネットワーク接続を確認してください。'],
            'https://www.google.com/' => ['accessible' => 'Googleウェブサイトにアクセス可能です。', 'notAccessible' => 'Googleウェブサイトにアクセスできません、ネットワーク接続を確認してください。'],
            'https://www.facebook.com/' => ['accessible' => 'Facebookウェブサイトにアクセス可能です。', 'notAccessible' => 'Facebookウェブサイトにアクセスできません、ネットワーク接続を確認してください。'],
            'https://www.twitter.com/' => ['accessible' => 'Twitterウェブサイトにアクセス可能です。', 'notAccessible' => 'Twitterウェブサイトにアクセスできません、ネットワーク接続を確認してください。'],
            'https://www.github.com/' => ['accessible' => 'GitHubウェブサイトにアクセス可能です。', 'notAccessible' => 'GitHubウェブサイトにアクセスできません、ネットワーク接続を確認してください。'],
        ],
