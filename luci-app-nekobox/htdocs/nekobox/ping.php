...
$langData = [
    'zh' => [
        ...
        'subscription_link_address' => '订阅链接地址:',
        'custom_template_url' => '自定义模板 URL:',
        'cron_job_set' => '定时任务已设置: ',
        'invalid_cron' => '无效的 Cron 表达式，请检查格式。',
        'subscription_url_empty' => '订阅 URL 不能为空。',
        'subscription_url_success' => '提交成功: 订阅 URL 已保存为: ',
        'shell_script_created' => 'Shell 脚本创建成功！路径: ',
        'shell_script_fail' => '创建 Shell 脚本失败。请检查权限。',
        'config_directory_fail' => '无法创建配置目录: ',
    ...
    'en' => [
        ...
        "title" => "Sing-box Conversion Template One",
        ...
        "save_button" => "Save",
        'form_title' => 'Sing-box Conversion Template Two',
        ...
        'subscription_link_address' => 'Subscription Link Address:',
        'custom_template_url' => 'Custom Template URL:',
        'cron_job_set' => 'Cron job set: ',
        'invalid_cron' => 'Invalid Cron expression. Please check the format.',
        'subscription_url_empty' => 'Subscription URL cannot be empty.',
        'subscription_url_success' => 'Submitted successfully: Subscription URL saved as: ',
        'shell_script_created' => 'Shell script created successfully! Path: ',
        'shell_script_fail' => 'Failed to create Shell script. Please check permissions.',
        'config_directory_fail' => 'Failed to create config directory: ',
    ...
    'mo' => [
        ...
        'subscription_link_address' => '訂閱鏈接地址:',
        'custom_template_url' => '自定義模板 URL:',
        'cron_job_set' => '定時任務已設置: ',
        'invalid_cron' => '無效的 Cron 表達式，請檢查格式。',
        'subscription_url_empty' => '訂閱 URL 不能為空。',
        'subscription_url_success' => '提交成功: 訂閱 URL 已保存為: ',
        'shell_script_created' => 'Shell 腳本創建成功！路徑: ',
        'shell_script_fail' => '創建 Shell 腳本失敗。請檢查權限。',
        'config_directory_fail' => '無法創建配置目錄: ',
    ...
    'kr' => [
        ...
        'subscription_link_address' => '구독 링크 주소:',
        'custom_template_url' => '사용자 정의 템플릿 URL:',
        'cron_job_set' => '정기 작업이 설정되었습니다: ',
        'invalid_cron' => '유효하지 않은 Cron 표현식입니다. 형식을 확인하세요.',
        'subscription_url_empty' => '구독 URL은 비워 둘 수 없습니다.',
        'subscription_url_success' => '제출 성공: 구독 URL이 다음에 저장되었습니다: ',
        'shell_script_created' => 'Shell 스크립트가 생성되었습니다! 경로: ',
        'shell_script_fail' => 'Shell 스크립트 생성에 실패했습니다. 권한을 확인하세요.',
        'config_directory_fail' => '구성 디렉토리를 생성할 수 없습니다: ',
    ...
    'jp' => [
        ...
        'subscription_link_address' => 'サブスクリプションリンクアドレス:',
        'custom_template_url' => 'カスタムテンプレートURL:',
        'cron_job_set' => 'Cronタスクが設定されました: ',
        'invalid_cron' => '無効なCron式です。形式を確認してください。',
        'subscription_url_empty' => 'サブスクリプションURLは空にできません。',
        'subscription_url_success' => '送信成功: サブスクリプションURLは次のように保存されました: ',
        'shell_script_created' => 'シェルスクリプトが正常に作成されました！パス: ',
        'shell_script_fail' => 'シェルスクリプトの作成に失敗しました。権限を確認してください。',
        'config_directory_fail' => '設定ディレクトリを作成できません: ',
    ...
    'ru' => [
        ...
        'subscription_link_address' => 'Адрес ссылки на подписку:',
        'custom_template_url' => 'Пользовательский URL шаблона:',
        'cron_job_set' => 'Задача Cron установлена: ',
        'invalid_cron' => 'Неверное Cron выражение, пожалуйста, проверьте формат.',
        'subscription_url_empty' => 'URL подписки не может быть пустым.',
        'subscription_url_success' => 'Отправка успешна: URL подписки сохранен как: ',
        'shell_script_created' => 'Shell скрипт успешно создан! Путь: ',
        'shell_script_fail' => 'Не удалось создать Shell скрипт. Пожалуйста, проверьте права.',
        'config_directory_fail' => 'Не удалось создать конфигурационную директорию: ',
    ...
    'ar' => [
        ...
        'subscription_link_address' => 'عنوان رابط الاشتراك:',
        'custom_template_url' => 'رابط قالب مخصص:',
        'cron_job_set' => 'تم تعيين مهمة كرون: ',
        'invalid_cron' => 'تعابير كرون غير صالحة، يرجى التحقق من التنسيق.',
        'subscription_url_empty' => 'رابط الاشتراك لا يمكن أن يكون فارغًا.',
        'subscription_url_success' => 'تم تقديم الاشتراك بنجاح: تم حفظ رابط الاشتراك على النحو التالي: ',
        'shell_script_created' => 'تم إنشاء سكربت الشيل بنجاح! المسار: ',
        'shell_script_fail' => 'فشل في إنشاء سكربت الشيل. يرجى التحقق من الأذونات.',
        'config_directory_fail' => 'تعذر إنشاء دليل التكوين: ',
    ...
    'es' => [
        ...
        'subscription_link_address' => 'Dirección del enlace de suscripción:',
        'custom_template_url' => 'URL de plantilla personalizada:',
        'cron_job_set' => 'Tarea cron configurada: ',
        'invalid_cron' => 'Expresión cron no válida, por favor revisa el formato.',
        'subscription_url_empty' => 'La URL de suscripción no puede estar vacía.',
        'subscription_url_success' => 'Envío exitoso: La URL de suscripción ha sido guardada como: ',
        'shell_script_created' => '¡Script de Shell creado con éxito! Ruta: ',
        'shell_script_fail' => 'Error al crear el script de Shell. Por favor, verifica los permisos.',
        'config_directory_fail' => 'No se pudo crear el directorio de configuración: ',
    ...
    'vn' => [
        ...
        'subscription_link_address' => 'Địa chỉ liên kết đăng ký:',
        'custom_template_url' => 'URL mẫu tùy chỉnh:',
        'cron_job_set' => 'Tác vụ Cron đã được cài đặt: ',
        'invalid_cron' => 'Biểu thức Cron không hợp lệ, vui lòng kiểm tra định dạng.',
        'subscription_url_empty' => 'URL đăng ký không thể để trống.',
        'subscription_url_success' => 'Gửi thành công: URL đăng ký đã được lưu là: ',
        'shell_script_created' => 'Kịch bản Shell đã được tạo thành công! Đường dẫn: ',
        'shell_script_fail' => 'Tạo kịch bản Shell thất bại. Vui lòng kiểm tra quyền.',
        'config_directory_fail' => 'Không thể tạo thư mục cấu hình: ',
...
function updateLanguage(lang) {
    ...
    document.querySelectorAll('[data-translate]').forEach((el) => {
        ...
        if (translations[translationKey]) {
            el.innerText = translations[translationKey];
        }
    });
...
let IP = {
    ...
    showDetailModal: async () => {
        ...
        let country = translatedCountry || data.country || langData[currentLang]['unknown'];
...
<div class="popup" id="popup">
    ...
    <button onclick="toggleAudio()" id="audio-btn" data-translate="toggle_audio">🔊 Toggle Audio</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="audio-player-container text-center">
          <button id="modalPlayPauseButton" class="btn btn-primary" data-translate="play">▶ Play</button>
...
document.getElementById('modalPrevButton').addEventListener('click', () => {
    ...
    showLogMessage(`${translations['previous_song']} ${songName}`);
});
...
document.getElementById('modalNextButton').addEventListener('click', () => {
    ...
    highlightCurrentSong(); 
    const songName = extractSongName(songs[currentSongIndex]);
    showLogMessage(`${translations['next_song']} ${songName}`);
});
...
window.addEventListener('keydown', function(event) {
    if (event.key === 'ArrowUp') {
        ...
        showLogMessage(`${translations['previous_song']}: ${songName}`);
        speakMessage(translations['previous_song']);
        updateTrackName();
        ...
        const songName = getSongName(songs[currentSongIndex]);
        showLogMessage(`${translations['next_song']}: ${songName}`);
        speakMessage(translations['next_song']);
        updateTrackName();
