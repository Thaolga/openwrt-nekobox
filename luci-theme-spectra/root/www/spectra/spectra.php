...
$langData = [
    'zh' => [
        ...
        'search_hint' => '提示：使用 * 作为通配符（如 "*.mp3" 搜索所有MP3文件）',
    ...
    'hk' => [
       ...
       'bangladesh'              => '孟加拉語',
        ...
        'search_hint' => '提示：使用 * 作為萬用字元（如 "*.mp3" 搜尋所有 MP3 檔案）',
    ...
    'ko' => [
        ...
        'search_hint' => '팁: * 를 와일드카드로 사용하세요 (예: "*.mp3")',
    ...
    'ja' => [
        ...
        'search_hint' => 'ヒント：* をワイルドカードとして使用（例 "*.mp3"）',
    ...
    'vi' => [
        ...
        'search_hint' => 'Mẹo: Dùng * làm ký tự đại diện (vd "*.mp3")',
    ...
    'th' => [
        ...
        'search_hint' => 'เคล็ดลับ: ใช้ * เป็นตัวแทน (เช่น "*.mp3")',
    ...
    'ru' => [
        ...
        'search_hint' => 'Совет: используйте * как шаблон (например "*.mp3")',
    ...
    'ar' => [
        ...
        'search_hint' => 'تلميح: استخدم * كحرف بدل (مثال "*.mp3")',
    ...
    'de' => [
        ...
        'search_hint' => 'Tipp: Verwenden Sie * als Platzhalter (z. B. "*.mp3")',
    ...
    'fr' => [
       ...
       'confirm_delete_file'   => 'Êtes-vous sûr de vouloir supprimer le fichier %s ?',
        ...
        'search_hint' => 'Astuce : utilisez * comme joker (ex "*.mp3")',
    ...
    'en' => [
        ...
        'search_hint' => 'Tip: Use * as a wildcard (e.g. "*.mp3" to search all MP3 files)',
    ...
    'bn' => [
        ...
        'search_hint' => 'টিপস: * ওয়াইল্ডকার্ড হিসেবে ব্যবহার করুন',
